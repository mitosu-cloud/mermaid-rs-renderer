...
Loads the most recent screenshots from `~/work/screenshots-mitosu` as visual reference for the current task. The screenshots are read into the conversation so Codex can see them and use them as context.
